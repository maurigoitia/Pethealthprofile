...
exports.approveAccessRequest = exports.syncNotebookKnowledge = exports.submitDataDeletionRequest = exports.deleteAllUserClinicalData = exports.deleteUserAccount = exports.backfillClinicalEpisodes = exports.backfillClinicalProjection = exports.onClinicalEventProjection = exports.syncTreatmentTimezoneV3 = exports.evaluateTreatmentDedupV3 = exports.recordDoseEventV3 = exports.markMissedTreatmentDosesV3 = exports.dispatchTreatmentRemindersV3 = exports.onTreatmentWriteScheduleV3 = exports.onMedicationWriteScheduleV3 = exports.uploadPetPhoto = exports.provisionPessyVertexDatastore = exports.pessyClinicalBrainGrounding = exports.ingestClinicalEmailWebhook = exports.cleanupLegacyMailsyncMedicalEvents = exports.backfillGmailTaxonomy = exports.backfillNarrativeHistory = exports.forceRunEmailClinicalIngestion = exports.runEmailClinicalAiWorker = exports.runEmailClinicalAttachmentWorker = exports.runEmailClinicalScanWorker = exports.runEmailClinicalIngestionQueue = exports.triggerEmailClinicalIngestion = exports.syncAppointmentCalendarEvent = exports.disconnectGmailSync = exports.gmailAuthCallback = exports.getGmailConnectUrl = exports.sendCoTutorInvite = exports.resolveBrainPayload = exports.generateClinicalSummary = exports.analyzeDocument = exports.cleanupOldNotifications = exports.recomputeClinicalAlertsDaily = exports.reconcileExistingTreatments = exports.sendGmailSyncConsentReminders = exports.sendBroadcastPushCampaigns = exports.sendDailyCareSummary = exports.sendScheduledNotifications = exports.ingestHistory = void 0;
...
async function sendEmailReminder(args) {
    ...
    const safePetNameSubject = (args.petName || "").replace(/[<>&"']/g, (c) => ({ "<": "&lt;", ">": "&gt;", "&": "&amp;", '"': "&quot;", "'": "&#39;" }[c] || c));
    const subject = isNow
    ...
    const safeMedName = (args.medicationName || "").replace(/[<>&"']/g, (c) => ({ "<": "&lt;", ">": "&gt;", "&": "&amp;", '"': "&quot;", "'": "&#39;" }[c] || c));
    const safeDosage = (args.dosage || "").replace(/[<>&"']/g, (c) => ({ "<": "&lt;", ">": "&gt;", "&": "&amp;", '"': "&quot;", "'": "&#39;" }[c] || c));
    const safePetName = (args.petName || "").replace(/[<>&"']/g, (c) => ({ "<": "&lt;", ">": "&gt;", "&": "&amp;", '"': "&quot;", "'": "&#39;" }[c] || c));
    const html = `
<!DOCTYPE html>
<html lang="es">
<head>

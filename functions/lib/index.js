...
exports.cleanupOldNotifications = exports.onAppointmentCreated = exports.sendScheduledNotifications = void 0;
...
exports.sendScheduledNotifications = functions.pubsub
    ...
    const results = await Promise.allSettled(snapshot.docs.map(async (docSnap) => {
        ...
        if (notification.repeat !== "none" && notification.repeatInterval) {
            const nextDate = new Date(new Date(notification.scheduledFor).getTime() +
            ...
            if (shouldScheduleNext) {
                await db.collection("scheduled_notifications").add(Object.assign(Object.assign({}, notification), { scheduledFor: nextDate.toISOString(), sent: false, createdAt: now.toISOString() }));
            }
        }

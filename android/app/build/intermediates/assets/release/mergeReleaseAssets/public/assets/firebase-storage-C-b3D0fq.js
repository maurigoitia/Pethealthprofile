import{_ as ge,C as me,r as z,S as Re,c as be,F as we,d as S,l as Te,z as ye,n as ke,k as Z,t as Ee,u as Ae,y as Ue}from"./firebase-app-BYvyCSk9.js";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function qe(e,t,n){let s=1,r=null,o=null,i=!1,a=0;function u(){return a===2}let h=!1;function d(...p){h||(h=!0,t.apply(null,p))}function R(p){r=setTimeout(()=>{r=null,e(b,u())},p)}function m(){o&&clearTimeout(o)}function b(p,...I){if(h){m();return}if(p){m(),d.call(null,p,...I);return}if(u()||i){m(),d.call(null,p,...I);return}s<64&&(s*=2);let T;a===1?(a=2,T=0):T=(s+Math.random())*1e3,R(T)}let w=!1;function k(p){w||(w=!0,m(),!h&&(r!==null?(p||(a=2),clearTimeout(r),R(0)):p||(a=1)))}return R(0),o=setTimeout(()=>{i=!0,k(!0)},n),k}function ze(e){e(!1)}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const pe="storage";function Ft(e,t,n){return e=S(e),Ot(e,t,n)}function Mt(e){return e=S(e),It(e)}function Ht(e,t){return e=S(e),Dt(e,t)}function $t(e=ke(),t){e=S(e);const s=Te(e,pe).getImmediate({identifier:t}),r=ye("storage");return r&&St(s,...r),s}function St(e,t,n,s={}){xt(e,t,n,s)}function Lt(e,{instanceIdentifier:t}){const n=e.getProvider("app").getImmediate(),s=e.getProvider("auth-internal"),r=e.getProvider("app-check-internal");return new q(n,s,r,t,Re)}function vt(){ge(new me(pe,Lt,"PUBLIC").setMultipleInstances(!0)),z(G,Y,""),z(G,Y,"esm2020")}vt();export{Mt as a,$t as g,Ht as r,Ft as u};

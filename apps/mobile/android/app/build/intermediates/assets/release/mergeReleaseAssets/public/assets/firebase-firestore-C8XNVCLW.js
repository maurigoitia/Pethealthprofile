import{L as om,c as am,d as It,F as um,f as ie,l as Ml,s as cs,k as Zo,t as Ol,u as cm,y as lm,n as hm,z as dm,A as fm,B as mm,D as gm,h as si,G as Ll,H as ql,_ as pm,C as _m,r as cc,S as ym}from"./firebase-app-BYvyCSk9.js";var lc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce=new om("@firebase/firestore");function xn(){return Ce.logLevel}function wy(r){Ce.setLogLevel(r)}function x(r,...t){if(Ce.logLevel<=ie.DEBUG){const e=t.map(ta);Ce.debug(`Firestore (${sr}): ${r}`,...e)}}function mt(r,...t){if(Ce.logLevel<=ie.ERROR){const e=t.map(ta);Ce.error(`Firestore (${sr}): ${r}`,...e)}}function Gt(r,...t){if(Ce.logLevel<=ie.WARN){const e=t.map(ta);Ce.warn(`Firestore (${sr}): ${r}`,...e)}}function ta(r){if(typeof r=="string")return r;try{return(function(e){return JSON.stringify(e)})(r)}catch{return r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

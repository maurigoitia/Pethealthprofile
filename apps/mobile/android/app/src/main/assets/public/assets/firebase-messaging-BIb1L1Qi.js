import{r as b,_ as m,C as y,l as O,E as Y,H as D,F as Ie,I as S,J as ke,B as Se,K as Ae,d as P,n as Ee}from"./firebase-app-DFmpqrB4.js";const z="@firebase/installations",M="0.6.21";/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Wt(e,t){const n=t.data;if(!n.isFirebaseMessaging)return;e.onMessageHandler&&n.messageType===w.PUSH_RECEIVED&&(typeof e.onMessageHandler=="function"?e.onMessageHandler(U(n)):e.onMessageHandler.next(U(n)));const o=n.data;Kt(o)&&o[ht]==="1"&&await Vt(e,n.messageType,o)}const G="@firebase/messaging",J="0.12.25";/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */async function Yt(){try{await ke()}catch{return!1}return typeof window<"u"&&Se()&&Ae()&&"serviceWorker"in navigator&&"PushManager"in window&&"Notification"in window&&"fetch"in window&&ServiceWorkerRegistration.prototype.hasOwnProperty("showNotification")&&PushSubscription.prototype.hasOwnProperty("getKey")}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Qt(e=Ee()){return Yt().then(t=>{if(!t)throw u.create("unsupported-browser")},t=>{throw u.create("indexed-db-unsupported")}),O(P(e),"messaging").getImmediate()}async function Zt(e,t){return e=P(e),ye(e,t)}function en(e,t){return e=P(e),zt(e,t)}Jt();export{Zt as a,Qt as g,Yt as i,en as o};

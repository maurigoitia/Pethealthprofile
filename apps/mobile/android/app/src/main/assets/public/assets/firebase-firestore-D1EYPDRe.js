import{L as om,c as am,d as It,F as um,f as ie,l as Fl,s as cs,k as Zo,t as Ol,x as cm,n as lm,y as hm,z as dm,A as fm,B as mm,h as si,D as Ll,G as ql,_ as gm,C as pm,r as cc,S as _m}from"./firebase-app-DFmpqrB4.js";var lc=typeof globalThis<"u"?globalThis:typeof window<"u"?window:typeof global<"u"?global:typeof self<"u"?self:{};/** @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */let sr="12.11.0";function ym(r){sr=r}/**
 * @license
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const Ce=new om("@firebase/firestore");function xn(){return Ce.logLevel}function Ey(r){Ce.setLogLevel(r)}function x(r,...t){if(Ce.logLevel<=ie.DEBUG){const e=t.map(ta);Ce.debug(`Firestore (${sr}): ${r}`,...e)}}function mt(r,...t){if(Ce.logLevel<=ie.ERROR){const e=t.map(ta);Ce.error(`Firestore (${sr}): ${r}`,...e)}}function Gt(r,...t){if(Ce.logLevel<=ie.WARN){const e=t.map(ta);Ce.warn(`Firestore (${sr}): ${r}`,...e)}}function ta(r){if(typeof r=="string")return r;try{return(function(e){return JSON.stringify(e)})(r)}catch{return r}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const P={OK:"ok",CANCELLED:"cancelled",UNKNOWN:"unknown",INVALID_ARGUMENT:"invalid-argument",DEADLINE_EXCEEDED:"deadline-exceeded",NOT_FOUND:"not-found",ALREADY_EXISTS:"already-exists",PERMISSION_DENIED:"permission-denied",UNAUTHENTICATED:"unauthenticated",RESOURCE_EXHAUSTED:"resource-exhausted",FAILED_PRECONDITION:"failed-precondition",ABORTED:"aborted",OUT_OF_RANGE:"out-of-range",UNIMPLEMENTED:"unimplemented",INTERNAL:"internal",UNAVAILABLE:"unavailable",DATA_LOSS:"data-loss"};class b extends um{constructor(t,e){super(t,e),this.code=t,this.message=e,this.toString=()=>`${this.name}: [code=${this.code}]: ${this.message}`}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");

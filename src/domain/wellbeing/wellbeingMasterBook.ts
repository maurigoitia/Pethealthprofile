...
export const WELLBEING_MASTER_BOOK: WellbeingMasterBook = {
  ...
  daily_suggestions: [
    // ─── Activos / Trabajo ───────────────────────────────────────────────────
    { id: "active_outdoor_safe", groupId: "dog.active_working", weatherCondition: "safe", category: "outdoor", title: "Sesion de entrenamiento al aire libre", detail: "30 min de trabajo estructurado: obediencia, obstaculos o busqueda. Ideal para gastar energia mental y fisica.", duration: "30 min", placeType: "park", gamificationPoints: 15, steps: ["Calentá con 5 min de caminata relajada", "Practicá 3 comandos de obediencia (sentate, echate, queda)", "Hacé un circuito de búsqueda con premios escondidos", "Enfriá con caminata lenta y estiramientos", "Ofrecé agua fresca al terminar"] },
    { id: "active_indoor_blocked", groupId: "dog.active_working", weatherCondition: "blocked", category: "indoor", title: "Juego de olfato en casa", detail: "Esconde premios en distintas habitaciones. Activa el cerebro tanto como una caminata larga.", duration: "20 min", placeType: "none", gamificationPoints: 10, steps: ["Elegí 5-8 premios chiquitos", "Mostráselos para que los huela", "Escondelos en distintas habitaciones mientras espera", "Dá la señal de buscar y dejá que explore", "Celebrá cada hallazgo con entusiasmo"] },
    { id: "active_training_any", groupId: "dog.active_working", weatherCondition: "any", category: "training", title: "Practica de autocontrol", detail: "5 repeticiones de 'espera' antes de comer y antes de salir. Reduce impulsividad.", duration: "10 min", placeType: "none", gamificationPoints: 8, steps: ["Poné el plato de comida en el piso", "Pedí 'espera' con mano abierta", "Contá 3 segundos antes de liberar", "Repetí aumentando a 5, luego 10 segundos", "Hacé lo mismo en la puerta antes de salir"] },

    // ─── Compania / General ──────────────────────────────────────────────────
    { id: "companion_walk_safe", groupId: "dog.companion", weatherCondition: "safe", category: "outdoor", title: "Paseo exploratorio sin prisa", detail: "Dejalo oler todo lo que quiera. El olfato cansa mas que correr.", duration: "20-40 min", placeType: "park", gamificationPoints: 12, steps: ["Salí sin apuro, correa relajada", "Dejá que elija la direccion", "Pará cada vez que quiera olfatear", "No tires de la correa, esperá", "Volvé a casa cuando se relaje naturalmente"] },
    { id: "companion_social_safe", groupId: "dog.companion", weatherCondition: "safe", category: "social", title: "Tarde en un cafe pet-friendly", detail: "Socializacion urbana. Perfecto para perros de compania que disfrutan del ambiente.", duration: "1 hora", placeType: "cafe", gamificationPoints: 15, steps: ["Elegí un café con espacio al aire libre", "Llevá agua y un snack para tu mascota", "Sentate en un lugar tranquilo, no cerca de la puerta", "Premiá la calma: si se echa tranquilo, dá un premio", "Si se estresa, no fuerces: volvé otro día"] },
    { id: "companion_grooming_any", groupId: "dog.companion", weatherCondition: "any", category: "grooming", title: "Revision semanal de rutina", detail: "Revisa orejas, encias, uas y manto. 10 minutos que previenen problemas grandes.", duration: "10 min", placeType: "none", gamificationPoints: 10, steps: ["Revisá las orejas: olor o enrojecimiento", "Mirá las encias: deben ser rosadas", "Chequeá las uñas: si tocan el piso, hay que cortarlas", "Pasá la mano por el manto buscando bultos", "Si encontrás algo raro, anotalo para el veterinario"] },
    { id: "companion_indoor_blocked", groupId: "dog.companion", weatherCondition: "blocked", category: "indoor", title: "Kong o juguete rellenable", detail: "Congela comida dentro de un Kong. Lo mantiene ocupado 20-30 minutos.", duration: "20-30 min", placeType: "none", gamificationPoints: 8, steps: ["Elegí un Kong o juguete rellenable", "Rellená con pasta de maní (sin xilitol) o comida húmeda", "Congelá por al menos 2 horas", "Dáselo en su lugar favorito", "Limpiá el juguete después del uso"] },

    // ─── Brachycephalicos ────────────────────────────────────────────────────
    { id: "brachy_indoor_blocked", groupId: "dog.brachycephalic", weatherCondition: "blocked", category: "indoor", title: "Actividad mental en interior", detail: "Juegos de olfato suaves, sin esfuerzo fisico. Evitar cualquier jadeo intenso.", duration: "15 min", placeType: "none", gamificationPoints: 10, steps: ["Esparcí premios por el piso de una habitacion", "Dejá que los busque con el olfato, sin apurarlo", "Agregá obstaculos suaves (almohadones, cajas)", "Rotá los escondites cada 3 minutos", "Terminá con agua fresca y descanso"] },
    { id: "brachy_walk_safe", groupId: "dog.brachycephalic", weatherCondition: "safe", category: "outdoor", title: "Paseo corto y tempranero", detail: "Maximo 15 minutos antes de las 9am o despues de las 7pm. Siempre con agua.", duration: "15 min", placeType: "park", gamificationPoints: 10, steps: ["Salí antes de las 9am o despues de las 7pm", "Llevá agua y un bowl portatil", "Caminá despacio, sin trotar", "Pará si empieza a jadear fuerte", "Volvé a casa antes de los 15 minutos"] },
    { id: "brachy_grooming_any", groupId: "dog.brachycephalic", weatherCondition: "any", category: "grooming", title: "Limpieza de pliegues faciales", detail: "Con gasa humeda, limpia los pliegues alrededor del hocico. Previene dermatitis.", duration: "5 min", placeType: "none", gamificationPoints: 12, steps: ["Humedecé una gasa con agua tibia", "Levantá suavemente cada pliegue del hocico", "Limpiá con movimientos suaves de adentro hacia afuera", "Secá bien cada pliegue con gasa seca", "Revisá si hay enrojecimiento o mal olor"] },

    // ─── Reactivos ───────────────────────────────────────────────────────────
    { id: "reactive_calm_walk", groupId: "dog.reactive", weatherCondition: "safe", category: "outdoor", title: "Paseo de descompresion", detail: "Sin personas ni perros cerca. Dejalo explorar a su ritmo. No corrijas, solo acompana.", duration: "20 min", placeType: "park", gamificationPoints: 12, steps: ["Elegí un horario con poca gente", "Usá correa larga (3-5 metros)", "Dejá que olfatee sin interrumpir", "Si ve otro perro, cambiá de direccion sin tirar", "Premiá cada momento de calma"] },
    { id: "reactive_indoor_any", groupId: "dog.reactive", weatherCondition: "any", category: "training", title: "Sesion de calma activa", detail: "Ensenale a tirarse y relajarse con premio. 5 repeticiones en un lugar tranquilo.", duration: "10 min", placeType: "none", gamificationPoints: 10, steps: ["Elegí un lugar tranquilo sin distracciones", "Esperá a que se eche solo, sin pedir", "Cuando se eche, dá un premio suave", "Repetí 5 veces con pausas de 1 minuto", "Terminá antes de que se aburra"] },

    // ─── Cachorros ───────────────────────────────────────────────────────────
    { id: "puppy_social_safe", groupId: "dog.puppy", weatherCondition: "safe", category: "social", title: "Exposicion controlada al entorno", detail: "Sacalo a ver personas, ruidos y texturas distintas. Ventana de socializacion critica.", duration: "15 min", placeType: "park", gamificationPoints: 15, steps: ["Llevalo a un lugar nuevo pero tranquilo", "Dejá que observe personas a distancia", "Premiá cada vez que mire algo nuevo sin asustarse", "Exponelo a una textura nueva (pasto, rejilla, arena)", "Volvé a casa antes de que se sobreestimule"] },
    { id: "puppy_training_any", groupId: "dog.puppy", weatherCondition: "any", category: "training", title: "Sesion de nombre y mirada", detail: "Di su nombre, cuando te mire, premio. 10 repeticiones. Base de toda la educacion futura.", duration: "5 min", placeType: "none", gamificationPoints: 10, steps: ["Tené premios chiquitos listos", "Decí su nombre una sola vez, con tono alegre", "Cuando te mire, premio inmediato", "Repetí 10 veces con pausas de 10 segundos", "Si no responde, acercá el premio a tu cara y repetí"] },

    // ─── Gatos ───────────────────────────────────────────────────────────────
    { id: "cat_enrichment_any", groupId: "cat.general", weatherCondition: "any", category: "indoor", title: "Enriquecimiento ambiental", detail: "Esconde comida en distintos lugares o usa un comedero interactivo. Activa el instinto cazador.", duration: "15 min", placeType: "none", gamificationPoints: 10, steps: ["Elegí 3-4 escondites distintos en la casa", "Poné porciones chicas de comida en cada uno", "Dejá que busque sin ayuda", "Rotá los escondites cada sesion", "Sumá un comedero interactivo si pierde interés"] },
    { id: "cat_grooming_any", groupId: "cat.general", weatherCondition: "any", category: "grooming", title: "Cepillado y revision de manto", detail: "Cepilla suavemente y revisa si hay cambios en la piel o el pelo. Momento de conexion.", duration: "10 min", placeType: "none", gamificationPoints: 8, steps: ["Esperá a que esté relajado (no jugando)", "Empezá cepillando el lomo con movimientos suaves", "Revisá detrás de las orejas y bajo el mentón", "Buscá zonas sin pelo o costras", "Si se irrita, pará y retomá otro día"] },
  ],

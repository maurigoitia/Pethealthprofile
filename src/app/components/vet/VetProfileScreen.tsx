  ...
  return (
    <div className="min-h-screen" style={{background:"#F0FAF9",fontFamily:"'Manrope',sans-serif"}}><div className="max-w-md mx-auto pb-24">
      ...
      <div className="px-5 space-y-4">
        ...
        <button onClick={()=>navigate("/login")} className="w-full bg-white rounded-[16px] p-4 text-left border border-[rgba(0,0,0,0.04)] shadow-[0_2px_8px_rgba(0,0,0,0.04)] flex items-center gap-3 active:translate-y-[-1px] transition-all duration-150"><span className="material-symbols-outlined text-[#074738]" style={{fontSize:"24px"}}>pets</span><div><p className="font-bold text-slate-900 text-sm">¿Tenés mascota?</p><p className="text-slate-500 text-xs">Ingresá a Pessy como tutor</p></div></button>

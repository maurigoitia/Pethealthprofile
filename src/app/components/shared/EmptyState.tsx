    ...
    <div className="flex flex-col items-center justify-center py-16 px-6 relative">
      ...
      <div className="mb-6 relative">
        {illustration && svgMap[illustration] ? (
          <div className="size-48 rounded-3xl bg-gradient-to-br from-[#074738]/5 to-emerald-50 dark:from-[#074738]/10 dark:to-emerald-950/20 p-6 flex items-center justify-center border-2 border-dashed border-[#074738]/20 animate-fade-up">

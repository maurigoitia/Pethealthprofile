...
export function NotificationsScreen({ onBack }: NotificationsScreenProps) {
  ...
  const Toggle = ({ active, onToggle, color = "bg-[#074738]", disabled = false }: {
      ...
      <div className="max-w-md mx-auto">
        <div className="bg-white dark:bg-slate-900 border-b border-slate-200 dark:border-slate-800">
          <div className="px-4 py-4 flex items-center gap-3">
            ...
            {saving && <div className="ml-auto size-4 border-2 border-[#074738]/30 border-t-[#074738] rounded-full animate-spin" />}
          </div>
        </div>
        ...
        <div className="p-4 space-y-4">
          ...
          <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-4">
            ...
            {permission !== "granted" && (
              <button onClick={requestPermission} className="mt-3 w-full py-2.5 rounded-lg bg-[#074738] text-white text-sm font-bold">
          ...
          {[
            ...
            { key: "appointments" as const, icon: "event", color: "bg-[#074738]", label: "Recordatorios de turnos", desc: "Te avisamos antes de cada cita" },
            { key: "results" as const, icon: "biotech", color: "bg-emerald-500", label: "Resultados de estudios", desc: "Te avisamos cuando estén listos" },

  ...
  <div className="w-full h-full bg-slate-50 p-4 font-['Manrope'] overflow-hidden select-none">
    <div className="space-y-3">
      <div className="flex items-center justify-between mb-4">
        <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">HISTORIAL RECIENTE</h4>
      ...
      {[
        { title: "Consulta General", date: "12 FEB", type: "Clinica", status: "Procesado" },
        { title: "Analisis de Sangre", date: "05 FEB", type: "Laboratorio", status: "Procesado" },
        { title: "Ecografia Abdominal", date: "28 ENE", type: "Imagen", status: "Pendiente" }
      ].map((item, i) => (
        <motion.div 
          key={i}
      ...
      <div className="mt-4 p-3 bg-[#074738] rounded-2xl text-white space-y-1 shadow-lg shadow-[#074738]/10">
        <div className="flex items-center gap-2">
          ...
          <p className="text-[9px] font-black uppercase tracking-widest">IA PESSY ANALIZANDO</p>
        </div>
        <p className="text-[10px] font-bold leading-tight opacity-90">Se detecto una tendencia en los valores renales. Sugerimos control en 30 dias.</p>
      </div>
    </div>
  </div>
);
...
export const MedicationMockup = () => (
  <div className="w-full h-full bg-slate-50 p-4 font-['Manrope'] overflow-hidden select-none">
    <div className="space-y-3">
      <div className="flex items-center justify-between mb-4">
        <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">TRATAMIENTOS ACTIVOS</h4>
      ...
      <div className="bg-white rounded-[2rem] p-4 border border-slate-100 shadow-sm space-y-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h5 className="text-sm font-black text-slate-900 leading-tight">Pimobendan 5mg</h5>
            <p className="text-[10px] font-black text-[#074738] uppercase tracking-wider">CADA 12 HORAS</p>
          </div>
        </div>

        <div className="grid grid-cols-2 gap-2">
          <div className="bg-slate-50 rounded-xl p-2.5">
            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-0.5">PROXIMA TOMA</p>
            <p className="text-xs font-black text-slate-900">20:00 HS</p>
          </div>
          <div className="bg-slate-50 rounded-xl p-2.5">
            <p className="text-[8px] font-black text-slate-400 uppercase tracking-widest mb-0.5">DOSIS</p>
            <p className="text-xs font-black text-slate-900">1 COMPRIMIDO</p>
          </div>
        </div>
      ...
      <div className="bg-amber-50 rounded-2xl p-3 border border-amber-100 flex gap-3">
        ...
        <p className="text-[9px] font-bold text-amber-800 leading-tight">Faltan 2 dias para que se termine el blister segun tu ritmo de registro.</p>
      </div>
    </div>
  </div>
);
  ...
  <div className="w-full h-full bg-slate-50 p-4 font-['Manrope'] overflow-hidden select-none">
    <div className="space-y-4">
      <div className="flex items-center justify-between">
        <h4 className="text-[10px] font-black uppercase tracking-[0.2em] text-slate-400">CARNET DIGITAL</h4>
      ...
      <div className="space-y-2">
        {[
          ...
          { name: "Tos de las perreras", date: "20 MAY 2026", status: "Pendiente", color: "slate" }
        ].map((vac, i) => (

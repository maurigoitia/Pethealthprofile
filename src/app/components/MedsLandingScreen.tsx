  ...
  return (
    <div className="min-h-screen bg-white font-['Manrope'] text-slate-900 overflow-x-hidden">
      <SEO 
        ...
        canonical="https://pessy.app/soluciones/medicacion"
      />
        ...
        <footer className="py-12 px-6 border-t border-slate-100 text-center">
          <div className="max-w-7xl mx-auto space-y-4">
            ...
            <div className="pt-4 flex justify-center gap-8">
              ...
              <Link to="/soluciones/vacunas" className="text-xs font-black text-slate-700 hover:text-[#1a9b7d] uppercase tracking-widest transition-colors">Vacunas</Link>

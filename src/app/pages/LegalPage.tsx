    ...
    <div className="relative min-h-screen overflow-x-hidden bg-[#F0FAF9] text-[#0a2e23] selection:bg-[#1A9B7D] selection:text-white">
      ...
      <main className="relative z-10 pt-20">
        ...
        <DocSection 
          ...
          <p>Pessy es un aplicación integral para el cuidado de mascotas. El tratamiento de datos personales se realiza con el fin de proveer una plataforma centralizada para tutores, co-tutores y actores del sector pet care.</p>
          <HighlightBox>
            <strong className="text-[#074738] uppercase tracking-[0.2em] text-[10px] block mb-2">Responsable</strong>
            Pessy — aplicación integral para el cuidado de mascotas<br />
        ...
        <DocSection 
          ...
          <p>Pessy es un aplicación integral para el cuidado de mascotas que organiza informacion, documentos, turnos, rutinas y recordatorios. Algunas funciones pueden estructurar informacion proveniente de documentos o correos, pero Pessy no constituye un diagnostico medico ni reemplaza la consulta veterinaria profesional.</p>

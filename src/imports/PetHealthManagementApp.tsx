...
function Container6() {
  return (
    <div className="flex-[1_0_0] min-h-px min-w-px relative w-[328.717px]" data-name="Container">
      <div className="bg-clip-padding border-0 border-[transparent] border-solid content-stretch flex flex-col gap-[19.993px] items-start pt-[31.989px] relative size-full">
        <Button />
        <Button1 />
      </div>
    </div>
...
function Container4() {
  return (
    <div className="absolute content-stretch flex flex-col gap-[47.995px] h-[366.853px] items-center left-[31.99px] top-[243.09px] w-[328.717px]" data-name="Container">
      <Container5 />
      <Container6 />
    </div>
  );
